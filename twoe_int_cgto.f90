...
!****************************************************************************!
!  allocate(geom(ntCenters))
!  geom(:) = 1
!  allocate(SrepCGTO1(ntcgto,ntcgto,ntcgto,ntcgto))
!  SrepCGTO1(:,:,:,:)=0.d0

!!------TTTT------------
!  call CollMatRep(geom,izgrid,0.d0,0.d0,0.d0,0.d0,0.d0,0.d0,0.d0,0.d0,0.d0,tCenters,ntCenters,tCenters,ntCenters,tCenters,ntCenters,tCenters,ntCenters,SrepCGTO1,'a')
!  deallocate(geom)
...
!  call Compute_2eint_mo(ntcgto,ntcgto,ntcgto,ntcgto,ntmo,ntmo,ntmo,ntmo,tmo,tmo,tmo,tmo,SrepCGTO1,SrepMO1)
...
!         write(10,'(4(i5,1X),2(f30.16,3X))') l,k,j,i,SrepMO1(l,k,j,i)
...
!  double precision, dimension(ncgto4,nmo4) :: eig4
  ...
  double complex, dimension(ncgto1,nmo1) :: eig1
  double complex, dimension(ncgto2,nmo2) :: eig2
  double complex, dimension(ncgto3,nmo3) :: eig3
  double complex, dimension(ncgto4,nmo4) :: eig4
